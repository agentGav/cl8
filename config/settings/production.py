...
EMAIL_SUBJECT_PREFIX = env("DJANGO_EMAIL_SUBJECT_PREFIX", default="[Constellate]")
...
# only add this if we have mailgun set up, otherwise default to normal smtp email setup
